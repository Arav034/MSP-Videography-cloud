...
import { STUDIO_VALUES, STUDIO_STATS, STUDIO_TEAM } from "@/constants/aboutContent";
...
export default function About() {
  return (
    <>
      <SEO
        title="About Us"
        description="The story, values, and team behind MSP Videography — a studio built on patience, precision, and light."
        path="/about"
      />
