...
export default function ServicesPage() {
  return (
    <>
      <SEO
        title="Services"
        description="Editing, photography, videography, and broadcast production services from MSP Videography."
        path="/services"
      />
      ...
      <section className="bg-ink text-frost">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-20 text-center">
          <span className="eyebrow text-frost/50 mb-4 block">Not Sure Where to Start?</span>
