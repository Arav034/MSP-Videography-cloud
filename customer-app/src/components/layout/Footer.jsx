      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-frost/70">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:booking@mspvideography.com"
                  className="hover:text-white transition-colors"
                >
          ...
          <div>
            ...
            <p className="text-sm leading-5 text-frost/70 mb-4">
              Subscribe to get seasonal shoot
              availability alerts, gear test
              breakdowns, and color LUT releases.
            </p>
            ...
            <form className="flex items-center gap-2">
              ...
              <input
                ...
                className="min-w-0 flex-1 h-11 rounded-xl border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-frost/50 outline-none focus:border-blue-500 transition-colors"
              />

              <button
                type="submit"
                aria-label="Subscribe"
                className="w-11 h-11 shrink-0 rounded-xl bg-blue-600 flex items-center justify-center text-white hover:bg-blue-500 transition-colors"
              >
                <Send
                  size={18}
                  strokeWidth={1.8}
